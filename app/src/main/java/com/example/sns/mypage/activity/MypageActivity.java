...
public class MypageActivity extends AppCompatActivity implements HttpRequest.OnHttpResponseListener {
    ...
    private TextView tv_name, tv_nickname, tv_introduce, tv_postcount, tv_followercount, tv_followingcount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_profile = findViewById(R.id.img_profile); //프로필 사진
        tv_postcount = findViewById(R.id.textview_postcount);//게시물 수
        tv_followercount = findViewById(R.id.textview_followercount);//팔로워 수
        tv_followingcount = findViewById(R.id.textview_followingcount);//팔로잉 수
