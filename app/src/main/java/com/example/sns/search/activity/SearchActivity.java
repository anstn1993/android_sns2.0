package com.example.sns.search.activity;
...
import com.example.sns.search.fragment.SearchedPeopleFragment;
import com.example.sns.search.fragment.SearchedPlaceFragment;
import com.example.sns.search.fragment.SearchedPlaceListFragment;
import com.example.sns.search.fragment.SearchedTagFragment;
import com.example.sns.util.EmptyActivity;
import com.example.sns.util.SoftKeyboard;
...
public class SearchActivity extends AppCompatActivity {
    ...
    public interface SearchedPeopleListener {
        void isSearched(String searchText);
    }

    public interface SearchedTagListener {
        void isSearched(String searchText);
    }

    public interface SearchedPlaceListener {
        void isSearched(String searchText);
    }
