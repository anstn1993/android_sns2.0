...
import com.example.sns.search.adapter.SearchedPeopleAdapter;
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    requestBody.put("lastId", searchedPeopleItemArrayList.get(searchedPeopleItemArrayList.size()-2).getId());//현재 로드된 사용자 리스트의 마지막 id
