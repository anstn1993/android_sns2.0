...
import com.example.sns.search.adapter.SearchedPlaceAdapter;
...
public class SearchedPlaceFragment extends Fragment implements SearchActivity.SearchedPlaceListener, SearchedPlaceAdapter.SearchedPlaceRecyclerViewListener, HttpRequest.OnHttpResponseListener {
    ...
    public void onListClicked(int position) {
        ...
        bundle.putString("address", searchedPlaceItemArrayList.get(position).getAddress());
        bundle.putDouble("latitude", searchedPlaceItemArrayList.get(position).getLatitude());
        bundle.putDouble("longitude", searchedPlaceItemArrayList.get(position).getLongitude());
