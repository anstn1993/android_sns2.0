...
import static com.example.sns.search.fragment.SearchedPlaceListFragment.setDistance;
            ...
            try {
                ...
                if (requestType.equals("getPost")) {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        compareLocation.setLatitude(Double.parseDouble(postItem.getLatitude()));
                        compareLocation.setLongitude(Double.parseDouble(postItem.getLongitude()));
                        ...
                        if (distance > 0 && distance <= setDistance && !searchedAddress.equals(postItem.getAddress())) {
