                ...
                if (selectedUserItemArrayList.size() != 0) {
                    try {
                        ...
                        for (int i = 0; i < selectedUserItemArrayList.size(); i++) {
                            ...
                            String account = selectedUserItemArrayList.get(i).account;
                            String nickname = selectedUserItemArrayList.get(i).nickname;
                            String profile = selectedUserItemArrayList.get(i).profile;
