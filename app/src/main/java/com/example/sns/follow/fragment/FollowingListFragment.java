package com.example.sns.follow.fragment;
...
import com.example.sns.follow.adapter.FollowAdapter;
...
public class FollowingListFragment extends Fragment implements FollowAdapter.FollowListRecyclerViewListener, HttpRequest.OnHttpResponseListener {
    private String TAG = "FollowingListFragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_followinglist, container, false);
        ...
        rv_following = rootView.findViewById(R.id.recyclerview_following);
        ib_back = rootView.findViewById(R.id.imagebutton_back);

        //서치뷰의 힌트 값 셋
        sv.setQueryHint("팔로잉 검색");
        ...
        sv.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if (newText.length() == 0) {
                    ...
                    getFollowing("getFollowing", hostAccount, loginUser.getAccount(), false, searchText, 0);
                ...
                //검색어가 존재하는 경우
                    ...
                    Log.d("검색", newText);
                    searchText = newText;
                    //여기에 검색조건에 부합하는 데이터를 가져와서 셋해주는 코딩
                    getFollowing("getFollowing", hostAccount, loginUser.getAccount(), true, searchText, 0);
                }
    ...
    private void getFollowing(String requestType, String hostAccount, String myAccount, boolean isSearched, String searchText, int lastId) {
        try {
            ...
            HttpRequest httpRequest = new HttpRequest("GET", requestBody.toString(), "getfollowing.php", this);
            httpRequest.execute();
    ...
    public void onHttpResponse(String result) {
        if (result != null) {
            ...
            try {
                ...
                if (requestType.equals("getFollowing")) {
                    followListItemArrayList.clear();
                    JSONArray jsonArray = responseBody.getJSONArray("followinglist");
