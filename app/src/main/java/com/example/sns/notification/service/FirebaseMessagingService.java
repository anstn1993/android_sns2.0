...
import static com.example.sns.main.activity.MainActivity.tabHost;
import static com.example.sns.notification.activity.NotificationActivity.notificationActivity;
                ...
                if (tabHost.getCurrentTabTag().equals("notification")) {
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            notificationActivity.getNotificationData("getNotification", LoginUser.getInstance().getAccount(), 0, notificationActivity.getListSize());//알림 목록 데이터 가져오기;
                        }
                    });
