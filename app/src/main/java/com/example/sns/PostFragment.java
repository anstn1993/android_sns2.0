...
public class PostFragment extends Fragment implements PostAdapter.PostRecyclerViewListener, HttpRequest.OnHttpResponseListener {
    ...
    //댓글 버튼을 클릭한 게시물의 번호
    private int clickedCommentPost;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //리사이클러뷰 선언
        rv_post = rootView.findViewById(R.id.recyclerview_post);
        setRecyclerView();
                ...
                public void onClick(View v) {
                    ...
                    tv_yes.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            //게시물을 삭제하는 스레드 실행
                            deletePost(postItemArrayList.get(position).postNum, position);//게시물 삭제 메소드
                        }
                    });
