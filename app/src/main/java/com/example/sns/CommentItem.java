...
public class CommentItem {
    ...
    //댓글 본문 데이터
    int id, postNum, childCommentCount;
    String account, nickname, profile, comment, time;
    boolean isMyComment;


    //대댓글을 담을 어레이리스트
    ArrayList<ChildCommentItem> childCommentList = new ArrayList<>();

    //대댓글을 업로드했을 때 업로드한 대댓글의 id를 담을 arraylist
    ArrayList<Integer> uploadedChildCommentChildNum = new ArrayList<>();
