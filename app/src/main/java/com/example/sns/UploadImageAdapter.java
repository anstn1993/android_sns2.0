...
//import static com.example.sns.UploadFirstActivity.selectedImage;
...
public class UploadImageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements ItemTouchHelperCallback.OnItemMoveListener {
    ...
    ArrayList<UploadImageItem> uploadImageItemArrayList = null;
    ...
    UploadImageRecyclerViewClickListener mListener;


    //리사이클러뷰를 클릭했을 때 동작할 메소드를 붙여줄 인터페이스
    interface UploadImageRecyclerViewClickListener{
    ...
    //어댑터의 생성자
    UploadImageAdapter(ArrayList<UploadImageItem> uploadImageItemArrayList, Activity context){
...
//        Glide.get(context).clearMemory();
            ...
            if(mListener != null){
                ...
                //리사이클러뷰의 이미지를 길게 클릭할 때의 리스너
//                ((ViewHolder)holder).iv_image.setOnTouchListener(new View.OnTouchListener() {
//                    @Override
