        ...
        sv.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if (newText.length() == 0) {
                    ...
                    getFollowing("getFollowing", hostAccount, LoginActivity.account, false, searchText, 0);
                ...
                //검색어가 존재하는 경우
                    ...
                    getFollowing("getFollowing", hostAccount, LoginActivity.account, true, searchText, 0);
                }
