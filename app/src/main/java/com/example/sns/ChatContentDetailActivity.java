...
public class ChatContentDetailActivity extends AppCompatActivity {
    ...
    private String clickedContent;//채팅화면에서 클릭한 컨텐츠의 파일명
    private String clickedContentType;//클릭한 컨텐츠의 타입(image or video)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            ...
            clickedContentType = chatContentDetailItemArrayList.get(currentPosition).type;
            clickedContent = chatContentDetailItemArrayList.get(currentPosition).content;
            clickedNickname = chatContentDetailItemArrayList.get(currentPosition).nickname;
            clickedTime = chatContentDetailItemArrayList.get(currentPosition).time;
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                String nickname = chatContentDetailItemArrayList.get(position).nickname;
                String time = chatContentDetailItemArrayList.get(position).time;
                String date = formatDate(time, fromFromat, toFormat);
                tv_nickname.setText(nickname);
                tv_time.setText(date);
                //바뀌기 이전 페이지의 content type이 video인 경우 player release를 해준다
                if (viewPagerAdapter.getContentFragment(currentPosition) != null && chatContentDetailItemArrayList.get(currentPosition).type.equals("video")) {
                ...
                if (chatContentDetailItemArrayList.get(position).type.equals("video")) {
        ...
        tv_download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String content = chatContentDetailItemArrayList.get(viewPager.getCurrentItem()).content;
                String type = chatContentDetailItemArrayList.get(viewPager.getCurrentItem()).type;
