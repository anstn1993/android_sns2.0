...
public class TestCompressMedia {

    private static final String TAG = TestCompressMedia.class.getSimpleName();
    ...
    private static final int OUTPUT_VIDEO_BIT_RATE = 700000; // 2Mbps
    ...
    public TestCompressMedia(String uri, String fileName, Context context, int width, int height) {
        this.mSourceUri = uri;
    ...
    public String testExtractDecodeEditEncodeMuxAudioVideo() throws Throwable {
//        progressDialog = new ProgressDialog(context);
//        progressDialog.setCancelable(false);
//        progressDialog.show(context, "동영상 업로드", "잠시만 기다려주세요");
//        setSize(1280, 720);
        setSource(mSourceUri);
        setCopyAudio();
        setCopyVideo();
...
//        progressDialog.dismiss();
    ...
    private static class TestWrapper implements Runnable {
        ...
        private TestCompressMedia mTest;

        private TestWrapper(TestCompressMedia test) {
            mTest = test;
        }
         ...
         * Entry point.
         */
        public static void runTest(TestCompressMedia test) throws Throwable {
            test.setOutputFile();
    ...
    private MediaExtractor createExtractor() throws IOException {
        ...
        extractor.setDataSource(mSourceUri);
        return extractor;
    }
