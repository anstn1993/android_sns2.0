...
import com.example.sns.chat.adapter.ChatContentListAdapter;
...
public class ChatContentListActivity extends AppCompatActivity implements ChatContentListAdapter.ChatImageRecyclerViewListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            ...
            for (int i = 0; i < totalImageCount; i++) {
                ...
                chatContentListItem.setIsSelectMode(false);
                chatContentListItem.setIsSelected(false);
        ...
        ib_check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < chatContentArrayList.size(); i++) {
                    chatContentArrayList.get(i).setIsSelectMode(true);
                }
        ...
        tv_cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //모든 이미지의 선택 모드를 해제한다.
                for (int i = 0; i < chatContentArrayList.size(); i++) {
                    chatContentArrayList.get(i).setIsSelectMode(false);//선택모드 해제
                    chatContentArrayList.get(i).setIsSelected(false);//모든 이미지를 미선택 상태로 전환
                }
    ...
    public void onContentClicked(int position) {
        ...
        if (isSelectMode == false) {
            ...
            for (int i = 0; i < chatContentArrayList.size(); i++) {
                ...
                intent.putExtra("contentData" + i, chatContentArrayList.get(i).getContentData());
            }
        ...
        //컨텐츠 선택 모드인 경우
            ...
            //선택 상태인 경우
            if (chatContentArrayList.get(position).getIsSelected()) {
                chatContentArrayList.get(position).setIsSelected(false);//선택 취소로 전환
            ...
            //선택을 하지 않은 상태면
                ...
                chatContentArrayList.get(position).setIsSelected(true);//선택 상태로 전환
    ...
    public void onBackPressed() {
        ...
        if (isSelectMode == true) {
            ...
            //모든 이미지의 선택 모드를 해제한다.
            for (int i = 0; i < chatContentArrayList.size(); i++) {
                chatContentArrayList.get(i).setIsSelected(false);//선택모드 해제
                chatContentArrayList.get(i).setIsSelectMode(false);//모든 이미지를 미선택 상태로 전환
            }
            chatContentListAdapter.notifyItemRangeChanged(0, chatContentListAdapter.getItemCount(), "cancel");
        }
        ...
        protected String doInBackground(ArrayList<Integer>... params) {
            ...
            try {
                ...
                for (int i = 0; i < selectedContentIndexList.size(); i++) {
                    ...
                    JSONObject contentData = new JSONObject(chatContentArrayList.get(selectedContentIndexList.get(i)).getContentData());
