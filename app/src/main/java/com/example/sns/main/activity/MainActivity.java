package com.example.sns.main.activity;
...
import com.example.sns.post.upload.activity.UploadActivity;
import com.example.sns.post.upload.activity.UploadFirstActivity;
import com.example.sns.post.upload.activity.UploadVideoFirstActivity;
...
//                                                startActivity(intent);//업로드 액티비티로 인텐트
    ...
    //이미 백그라운드에 존재하는 작업의 백스택에 존재하는 경우 onNewIntent()로 호출
    @Override
